...
namespace ProfileMatching.Migrations
{
    ...
    [Migration("20230204165805_database-drop")]
    partial class databasedrop
    {
            ...
            modelBuilder.Entity("ProfileMatching.Models.JobPosition", b =>
                {
                    ...
                    b.HasOne("ProfileMatching.Models.AppUser", "AppUser")
                        .WithMany("PublishedJobs")
                        .HasForeignKey("userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
